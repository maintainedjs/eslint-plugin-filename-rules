    ...
    invalid: [
      {
        ...
        errors: [
          {
            message: "Filename 'test.txt' must not match /^test(?:\\..*)?$/.",
            column: 1,
            line: 1,
          },
        ],
    ...
    invalid: [
      {
        ...
        errors: [
          {
            message: "Filename '/foo/bar/test.txt' must not match /^.*bar.*$/.",
            column: 1,
            line: 1,
          },
        ],
...
test("throws on unknown alias", () => {
  expect(
    ...
    `ESLint configuration in rule-tester is invalid: Key "rules": Key "rule-to-test/not-match":
      ...
      invalid: [
        {
          ...
          errors: [
            {
              message: `Filename 'module.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
        },
        {
          ...
          errors: [
            {
              message: `Filename 'anotherModule.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
        },
        {
          ...
          errors: [
            {
              message: `Filename 'module.test.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
      ...
      invalid: [
        {
          ...
          errors: [
            {
              message: `Filename 'Url.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
        ...
        },
        {
          ...
          errors: [
            {
              message: `Filename 'AnotherModule.test.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
        },
        {
          ...
          errors: [
            {
              message: `Filename 'ModuleNameWithACRONYM.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
    ...
    testRule({
      invalid: [
        ...
        },
        {
          ...
          errors: [
            {
              message: `Filename 'another_module.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
        },
        {
          ...
          errors: [
            {
              message: `Filename 'another_module.test.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
    ...
    testRule({
      invalid: [
        ...
        },
        {
          ...
          errors: [
            {
              message: `Filename 'another-module.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
        },
        {
          ...
          errors: [
            {
              message: `Filename 'another-module.test.js' must not match ${alias}.`,
              column: 1,
              line: 1,
            },
          ],
    ...
    invalid: [
      {
        ...
        errors: [
          {
            message: "Filename 'someModule.js' must not match camelcase.",
            column: 1,
            line: 1,
          },
        ],
      },
      {
        ...
        errors: [
          {
            message:
              "Filename 'some-module.ts' must not match /^([a-z]+-)*[a-z]+(?:\\..*)?$/.",
            column: 1,
            line: 1,
          },
        ],
